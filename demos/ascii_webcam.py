#!/usr/bin/env python3
"""Demo random que no tiene nada que ver con la detección de armas: convierte
el feed de la webcam a arte ASCII en la terminal, en vivo. La usé en la
sustentación para explicar de forma más visual eso de que una imagen, para
la computadora, es solo una matriz de números.
