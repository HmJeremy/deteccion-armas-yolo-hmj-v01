#!/usr/bin/env python3
"""Otra demo para la sustentación: descompone una imagen en sus canales
B/G/R y guarda los valores de cada canal como archivos de texto, para
mostrar en la práctica que una imagen es, para la computadora, solo una
